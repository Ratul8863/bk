  ...
  research: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'status',
        tab: 'content',
        help: 'Only Published items appear on the public Research page.',
      },
      {
      ...
      },
      {
        ...
        help: 'Attached link visitors open when they click this item. There is no separate detail page.',
      },
      {
        name: 'areaIds',
        label: 'Focus areas',
